...
export const FORMATIONS = {
  10: {
    ...
    4: [
      ...
      // Centre line: gap(1|2) · 5 · gap(7|8) · 9  =  1.5 · 5 · 7.5 · 9
      { name: 'Line', slots: [5, 9], lineCups: [{ x: 1.5, y: 0 }, { x: 1.5, y: 2 }] },
    ],
    3: [
      ...
      // Centre line: gap(1|2) · 5 · gap(7|8)  =  1.5 · 5 · 7.5
      { name: 'Line', slots: [5], lineCups: [{ x: 1.5, y: 0 }, { x: 1.5, y: 2 }] },
    ],
    2: [
      ...
      // Centre line: gap(1|2) · 5  =  1.5 · 5
      { name: 'Line', slots: [5], lineCups: [{ x: 1.5, y: 0 }] },
    ],
    1: [
  ...
  6: {
    ...
    3: [
      ...
      // Centre line: 1 · gap(3|4) · 5
      { name: 'Line', slots: [1, 5], lineCups: [{ x: 1, y: 1 }] },
    ],
    2: [
      { name: 'Side by side L', slots: [0, 1] },
      ...
      // Centre line: 1 · gap(3|4)
      { name: 'Line', slots: [1], lineCups: [{ x: 1, y: 1 }] },
    ],
    1: [
      { name: 'Single (0)', slots: [0] },
      { name: 'Single (1)', slots: [1] },
